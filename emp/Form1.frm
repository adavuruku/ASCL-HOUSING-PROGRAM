...
Private Sub cmdFirst_Click()
    ...
    txtPhone.Text = rs(3)
    txtdepartment.Text = rs(5)
Set pic2.Picture = LoadPicture(App.Path & "\photos\" & rs("e_no") & ".jpg")
End Sub
...
'info = "\\192.168.0.2\microbanking\photos\" & myphoto
'mpath = "\\192.168.0.2\"
'mpath = "F:\"
'F:\emp\photos
'info = mpath & "emp\photos\" & myphoto

'Set pic2.Picture = LoadPicture(info & ".jpg")
